...
//		iconLabel.setMaximumSize(new Dimension(200, 200));
		...
		airQuality1.setText("Co: "+hm.get("Co"+0)+" µg/m3 \r\n"
				+ "NO2: "+hm.get("No2"+0)+" µg/m3 \r\n"
				+ "O3: "+hm.get("O3"+0)+" µg/m3 \r\n"
				+ "Pm10: "+hm.get("Pm10"+0)+" µg/m3 \r\n"
				+ "Pm25: "+hm.get("Pm25"+0)+" µg/m3 \r\n"
				+ "So2: "+hm.get("So2"+0)+" µg/m3");
		airQuality1.setEditable(false);
		add(airQuality1, "cell 1 9,alignx center,aligny top");

		JTextPane airQuality2 = new JTextPane();
		airQuality2.setText("Co: "+hm.get("Co"+1)+" µg/m3 \r\n"
				+ "NO2: "+hm.get("No2"+1)+" µg/m3 \r\n"
				+ "O3: "+hm.get("O3"+1)+" µg/m3 \r\n"
				+ "Pm10: "+hm.get("Pm10"+1)+" µg/m3 \r\n"
				+ "Pm25: "+hm.get("Pm25"+1)+" µg/m3 \r\n"
				+ "So2: "+hm.get("So2"+1)+" µg/m3");
		airQuality2.setEditable(false);
		add(airQuality2, "cell 3 9,alignx center,aligny top");

		JTextPane airQuality3 = new JTextPane();
		airQuality3.setText("Co: "+hm.get("Co"+2)+" µg/m3 \r\n"
				+ "NO2: "+hm.get("No2"+2)+" µg/m3 \r\n"
				+ "O3: "+hm.get("O3"+2)+" µg/m3 \r\n"
				+ "Pm10: "+hm.get("Pm10"+2)+" µg/m3 \r\n"
				+ "Pm25: "+hm.get("Pm25"+2)+" µg/m3 \r\n"
				+ "So2: "+hm.get("So2"+2)+" µg/m3");
		airQuality3.setEditable(false);
		add(airQuality3, "cell 5 9,alignx center,aligny top");

		JTextPane airQuality4 = new JTextPane();
		airQuality4.setText("Co: "+hm.get("Co"+3)+" µg/m3 \r\n"
				+ "NO2: "+hm.get("No2"+3)+" µg/m3 \r\n"
				+ "O3: "+hm.get("O3"+3)+" µg/m3 \r\n"
				+ "Pm10: "+hm.get("Pm10"+3)+" µg/m3 \r\n"
				+ "Pm25: "+hm.get("Pm25"+3)+" µg/m3 \r\n"
				+ "So2: "+hm.get("So2"+3)+" µg/m3");
		airQuality4.setEditable(false);
		add(airQuality4, "cell 7 9,alignx center,aligny top");

		JTextPane airQuality5 = new JTextPane();
		airQuality5.setText("Co: "+hm.get("Co"+4)+" µg/m3 \r\n"
				+ "NO2: "+hm.get("No2"+4)+" µg/m3 \r\n"
				+ "O3: "+hm.get("O3"+4)+" µg/m3 \r\n"
				+ "Pm10: "+hm.get("Pm10"+4)+" µg/m3 \r\n"
				+ "Pm25: "+hm.get("Pm25"+4)+" µg/m3 \r\n"
				+ "So2: "+hm.get("So2"+4)+" µg/m3");
